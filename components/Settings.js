                ...
                <View style={[Styles.column]}>
                  <View style={[Styles.column, Styles.teams, Styles.greenBox]}>
                      ...
                      <View style={[Styles.row]}>
                        <Pressable onPress={() => AsyncStorage.setItem('league', Constants.ID_PREMIER.toString()).then(alert(I18n.t('leaguePreferencesPremier')))}>
                          <Image source={{ uri: Image.resolveAssetSource(Premier).uri}} style={[Styles.imageSettings]}/>
                        </Pressable>
                        <Pressable onPress={() => AsyncStorage.setItem('league', Constants.ID_LIGA.toString()).then(alert(I18n.t('leaguePreferencesLiga')))}>
                          <Image source={{ uri: Image.resolveAssetSource(Liga).uri}} style={[Styles.imageSettings]}/>
                        </Pressable>
                        <Pressable onPress={() => AsyncStorage.setItem('league', Constants.ID_BUNDES.toString()).then(alert(I18n.t('leaguePreferencesBundesliga')))}>
                  ...
                  <View style={[Styles.column, Styles.teams, Styles.greenBox]}>
                      ...
                      <View style={[Styles.row, Styles.rowSettings]}>
                        <Pressable style={Styles.buttonSettings} onPress={() => AsyncStorage.setItem('games', '10').then(alert(I18n.t('gamesPreferences10')))}>
                          <Text style={Styles.textButton}>10</Text>
                        </Pressable>
                        <Pressable style={Styles.buttonSettings} onPress={() => AsyncStorage.setItem('games', '20').then(alert(I18n.t('gamesPreferences20')))}>
                          <Text style={Styles.textButton}>20</Text>
                        </Pressable>
                        <Pressable style={Styles.buttonSettings} onPress={() => AsyncStorage.setItem('games', '30').then(alert(I18n.t('gamesPreferences30')))}>
